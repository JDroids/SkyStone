...
public class EpsilonSkyStonePipeline extends OpenCvPipeline{
    ...
    private final Scalar maxHSV = new Scalar(60, 255.0, 255.0);

    private final Point anchor = new Point(-1,-1);
    private final int erodeIterations = 3;

    private final int dilateIterations = 5;
